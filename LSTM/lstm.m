...
numOut = 1;
% weight matrices
theta_xi = 2 * randn(numIn + 1,1); %weights for input X and bias to input gate
theta_xf = 2 * randn(numIn + 1,1); %weights for input X and bias to forget gate
theta_xo = 2 * randn(numIn + 1,1); %weights for input X and bias to output gate
theta_xg = 2 * randn(numIn + 1,1); %weights for input X and bias to net input
